...
export const feedPostsQuery = (uid) =>
  query(collection(db, "posts"), orderBy("createdAt", "desc")); // will update this query to actual feed posts query once followers, following functionality is done
